...
<body>
	...
	<div class="buildings">
		<div class="container">
			...
			<c:forEach items="${bldList}" var="sum"    varStatus="j" >
				<div class="building-one">
				<c:forEach items="${bldList}" var="bld"  begin="${(j.count-1)*4}" end="${(j.count)*4-1}">
					<div class="col-md-3 building-left">
						<a href="${pageContext.request.contextPath}/homeAction/getBuildIntro.do?bldNo=${bld.BLD_NO}">
							<div style="height:240px;width:240px">
								<img src="../upload/${bld.BLD_IMG}" alt="无图片" height="230" width="240"/>
							</div>
						</a>
						<a href="${pageContext.request.contextPath}/homeAction/getBuildIntro.do?bldNo=${bld.BLD_NO}">
							<h4>${bld.BLD_NO}${bld.BLD_NM }</h4>
						</a>
						<p>位于${bld.SITE },总投资${BLD_INVEST_MO}</p>
						<div class="build-btn">
							<a href="${pageContext.request.contextPath}/homeAction/getBuildIntro.do?bldNo=${bld.BLD_NO}" class="hvr-shutter-out-horizontal">
								Read more
							</a>
						</div>
					</div>
		...
		<div class="container">
			<div class="footer-top">
				 <div class="col-md-5 footer-left">
					<p>Copyright &copy; 2015.menco-cwh.</p> 
				</div>
