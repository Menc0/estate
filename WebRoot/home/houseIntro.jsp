		...
		<div class="container" style="margin-bottom:50px">
			<div class="blog-top">
				<div class="col-md-9 blog-left">
					<div class="blog-main">
						<a class="bg">${houseIntro.houseIntro.HOS_NO}</a>
						<p>位于 
							<a href="${pageContext.request.contextPath}/homeAction/searchHouse.do?bldNo=${houseIntro.houseIntro.BLD_NO}">
								${houseIntro.houseIntro.BLD_NO}楼
							</a>
								,${houseIntro.houseIntro.HOS_TP}面积${houseIntro.houseIntro.HOS_AREA}总价￥${houseIntro.houseIntro.SELL_PCE}
						</p>
					</div>								
					<div class="blog-main-one">
						<div class="blog-one blog-sng">
							<img src="../upload/${houseIntro.houseIntro.HOS_IMG}" alt="无图片" />
							<p class="sngl">${houseIntro.houseIntro.HOS_INTRO}</p>
						</div>	
						...
						<div class="related">
							...
							<c:forEach items="${houseIntro.recmdHouse}" var="house" end="3">
